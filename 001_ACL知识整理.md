...
![ACL判定示意图](https://raw.githubusercontent.com/hedywang1212-hash/dify_Knowledge/main/images/001_01.jpg)

图片说明：  
ACL 判定时先检查表级 ACL，再检查字段级 ACL。  
同级多条规则是 OR 关系，表级和字段级之间是 AND 关系。
