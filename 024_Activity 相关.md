Activity在画面上点击提交后，会在sys_journal_field表中生成日志
...
历史活动会保存在sys_history_set，sys_history_line表中
...
如果想要修改additional comments的时候，先修改sys_audit中的value值,这时候会发现activity中改过的值没有变
